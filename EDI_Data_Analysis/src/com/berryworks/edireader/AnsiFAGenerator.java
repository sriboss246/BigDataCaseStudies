...
public class AnsiFAGenerator extends ReplyGenerator
{
  ...
  private final com.berryworks.edireader.util.BranchingWriter ackStream;
  ...
  public AnsiFAGenerator(final StandardReader ansiReader, final com.berryworks.edireader.util.BranchingWriter ackStream)
  {
                                               ...
                                               String groupVersion) throws IOException
  {
    ...
    String faHeader = firstSegment.substring(0, 32) + sender + receiver
      + com.berryworks.edireader.util.DateTimeGenerator.generate(delimiter)
