 ...
 * it may be convenient to inherit from this SAXAdapter and avoid some of the tedious aspects
 * of detecting EDI structures in the SAX interface.
 * <p/>
 * See also the EDIReaderSAXAdapter which serves a similar purpose.
