...
public class SchemaBuilder {
    ...
    private static Map<Short, Schema.Type> primitives = new HashMap<Short,Schema.Type>();
    static {
    ...
    public Schema createSchema(File file) throws ConverterException, IOException {
    ...
    public Schema createSchema(XSModel model) {
        ...
        Map<Source, Schema> schemas = new LinkedHashMap<Source, Schema>();
    ...
    private Schema createGroupSchema(String name, XSModelGroup groupTerm) {
      ...
      Map<String, Schema.Field> fields = new HashMap<String, Schema.Field>();
    ...
    private List<Schema.Field> createFields(XSComplexTypeDefinition type) {
        final Map<String, Schema.Field> fields = new LinkedHashMap<String, Schema.Field>();
